...
//         string systemPrompt = systemPrompts[characterNo] +
...
//         {
//             recentContext += dialogueEntries[i].characterName + ": " + dialogueEntries[i].dialogueText + " ";
//         }
...
//             {
//                 Message assistantMessage = response.choices[0].message;
//                 string question = assistantMessage.content.Trim();
//                 string charName = Characters[characterNo].myName.Trim();

//                 // Remove character name prefix if present
//                 if (question.StartsWith(charName))
//                 {
...
//                     else
//                     {
//                         question = question.Substring(charName.Length).Trim();
//                     }
//                 }

//                 // Log dialogue entry
//                 DialogueEntry entry = new DialogueEntry(characterNo, Characters[characterNo].name, question);
//                 dialogueEntries.Add(entry);
//                 events.Add(Characters[characterNo].myName + " asked: " + question);
...
//                 if (mySaveController != null)
//                 {
//                     mySaveController.NewEntryDialogue(systemPrompt, userPrompt, question);
//                 }
//             }
//         ));
//     }
